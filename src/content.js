...
export const SUMMATIVE = [
  {
    ...
    options: ["Station 2", "Station 3", "Station 4", "Station 1"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["17 blades (more = higher σ)", "Slip factor doesn't depend on blade count", "Both are identical because diameter is fixed", "9 blades (fewer = higher σ)"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["≈ 180 kJ/kg", "≈ 27 kJ/kg", "≈ 53 kJ/kg", "≈ 92 kJ/kg"],
    correct: 3,
